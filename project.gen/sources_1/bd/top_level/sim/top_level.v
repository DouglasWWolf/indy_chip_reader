...
module top_level
  ...
  output CHIP_VDDIO;
  output CHIP_VDDLVDS;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 LVDS_CLK CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME LVDS_CLK, CAN_DEBUG false, FREQ_HZ 100000000" *) output [0:0]LVDS_CLK_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 LVDS_CLK CLK_P" *) output [0:0]LVDS_CLK_clk_p;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 init_clk CLK_N" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME init_clk, CAN_DEBUG false, FREQ_HZ 200000000" *) input [0:0]init_clk_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:diff_clock:1.0 init_clk CLK_P" *) input [0:0]init_clk_clk_p;
  ...
  wire [0:0]init_clk_1_CLK_N;
  wire [0:0]init_clk_1_CLK_P;
  wire [0:0]lvds_clk_buffer_CLK_OUT_D3_CLK_N;
  wire [0:0]lvds_clk_buffer_CLK_OUT_D3_CLK_P;
  wire lvds_clk_clk_768;
  wire spi_mosi_1;
  wire sys_clks_clk_250;
  ...
  assign LVDS_CLK_clk_n[0] = lvds_clk_buffer_CLK_OUT_D3_CLK_N;
  assign LVDS_CLK_clk_p[0] = lvds_clk_buffer_CLK_OUT_D3_CLK_P;
  assign init_clk_1_CLK_N = init_clk_clk_n[0];
  assign init_clk_1_CLK_P = init_clk_clk_p[0];
  ...
  top_level_indy_power_ctl_0_0 indy_power_ctl
       (.chip_power_ctl(controller_chip_power_ctl),
        ...
        .clk(sys_clks_clk_250),
        .resetn(controller_resetn_out));
  top_level_util_ds_buf_0_0 input_clk_buffer
       (.IBUF_DS_N(init_clk_1_CLK_N),
        .IBUF_DS_P(init_clk_1_CLK_P),
        .IBUF_OUT(util_ds_buf_0_IBUF_OUT));
  top_level_clk_wiz_0_1 lvds_clk
       (.clk_768(lvds_clk_clk_768),
        .clk_in1(util_ds_buf_0_IBUF_OUT));
  top_level_util_ds_buf_1_0 lvds_clk_buffer
       (.OBUF_DS_N(lvds_clk_buffer_CLK_OUT_D3_CLK_N),
        .OBUF_DS_P(lvds_clk_buffer_CLK_OUT_D3_CLK_P),
        .OBUF_IN(lvds_clk_clk_768));
